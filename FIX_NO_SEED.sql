...
-- -----------------------------------------------------------------------------
-- CORREÇÃO PARA REMOVER DADOS DE EXEMPLO (SEED)
-- -----------------------------------------------------------------------------
-- Copie todo o código abaixo e execute no SQL Editor do seu Dashboard Supabase.
-- Isso impedirá que novas lojas sejam criadas com produtos fictícios.
